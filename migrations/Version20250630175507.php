...
final class Version20250630175507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE business_user (id SERIAL NOT NULL, business_id  INT NOT NULL, user_id INT NOT NULL, responsibilities JSON NOT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'ALTER TABLE business_user ADD CONSTRAINT FK_DD08D444A89DB457 FOREIGN KEY (business_id) REFERENCES business (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
        $this->addSql(
            'ALTER TABLE business_user ADD CONSTRAINT FK_DD08D444A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
    }
